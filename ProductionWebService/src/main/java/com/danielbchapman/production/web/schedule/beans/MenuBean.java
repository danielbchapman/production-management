...
public class MenuBean
{
  ...
  public MenuItem[] getItems()
  {
    if(items == null)
    {
      ...
      production.addMenuItem(new SeasonMenuItem("season.xhtml", Roles.USER, SeasonBean.Selection.SUMMARY));
      production.addMenuItem(new SeasonMenuItem("season.xhtml", Roles.USER, SeasonBean.Selection.BUDGET));
      production.addMenuItem(new SeasonMenuItem("season.xhtml", Roles.USER, SeasonBean.Selection.DEPARTMENTS));
      production.addMenuItem(new SeasonMenuItem("season.xhtml", Roles.USER, SeasonBean.Selection.PETTY_CASH));
      production.addMenuItem(new SeasonMenuItem("season.xhtml", Roles.USER, SeasonBean.Selection.TASKS));
      production.addMenuItem(new SeasonMenuItem("season.xhtml", Roles.USER, SeasonBean.Selection.REPORTS));
      production.addMenuItem(new SeasonMenuItem("season.xhtml", Roles.USER, SeasonBean.Selection.CONTACTS));
      ...
      inventory.addMenuItem(new InventoryMenuItem("inventory.xhtml", Roles.GUEST, InventoryBean.Selection.GENERAL));
      inventory.addMenuItem(new InventoryMenuItem("inventory.xhtml", Roles.GUEST, InventoryBean.Selection.LIGHTING));
      inventory.addMenuItem(new InventoryMenuItem("inventory.xhtml", Roles.GUEST, InventoryBean.Selection.PROPS));
      inventory.addMenuItem(new InventoryMenuItem("inventory.xhtml", Roles.GUEST, InventoryBean.Selection.SCENIC));
      inventory.addMenuItem(new InventoryMenuItem("inventory.xhtml", Roles.GUEST, InventoryBean.Selection.SOUND));
      inventory.addMenuItem(new InventoryMenuItem("inventory.xhtml", Roles.GUEST, InventoryBean.Selection.STAGE_MANAGEMENT));
      inventory.addMenuItem(new InventoryMenuItem("inventory.xhtml", Roles.GUEST, InventoryBean.Selection.WARDROBE));
      inventory.addMenuItem(new InventoryMenuItem("inventory.xhtml", Roles.INVENTORY_ADMIN, InventoryBean.Selection.PROBLEMS));
      
      MenuItem schedule = new MenuItem("Scheduling", "setTimeZone.xhtml", Roles.GUEST);
      schedule.addMenuItem(new ScheduleMenuItem("setTimeZone.xhtml", Roles.GUEST, ScheduleBean.Selection.CALENDAR));
      schedule.addMenuItem(new ScheduleMenuItem("setTimeZone.xhtml", Roles.SCHEDULER, ScheduleBean.Selection.CITY));
      schedule.addMenuItem(new ScheduleMenuItem("setTimeZone.xhtml", Roles.SCHEDULER, ScheduleBean.Selection.PERFORMANCES));
      ...
      items = new MenuItem[]
          ...
          inventory,
          new MenuItem("Vendors", "vendors.xhtml", Roles.SCHEDULER),
          settings,
    ...
    public void onSelect(ActionEvent evt)
    {
      if(evt != null)
      {
        ...
        catch (IOException e)
        {
          ...
          try
          {
            FacesContext.getCurrentInstance().getExternalContext().responseSendError(500, "FATAL ERROR: Application Menu Unstable [MenueBean$MenueItem:81], please log out and try again.");
  ...
  public ActionMenuItem<Object> createActionMenuItem(String name, String beanBinding, String voidMethodName)
  {
