...
<html>
	<head>
		...
		<title>Login</title>		
		<script type="text/javascript" src="/./resources/resources/js/jquery-ui-1.8.15.custom.min.js"></script>
		<script type="text/javascript" src="/./resources/resources/js/jquery-1.6.2.min.js"></script>
		<link type="text/css" rel="stylesheet" href="/./resources/resources/css/production.css" />
		<link type="text/css" rel="stylesheet" href="/./resources/resources/css/cupertino/jquery-ui-1.8.15.custom.css" />
	</head>
